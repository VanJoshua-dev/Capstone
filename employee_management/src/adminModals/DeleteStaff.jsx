...
function DeleteStaff({ onClose, onSubmit }) {
  //handle show pass
      ...
      >
        ...
        <div className="px-5 py-4 flex flex-col gap-4">
          ...
          <p className="text-amber-600 flex font-light items-center gap-1"><PiWarningCircle size={20}/> Warning this action canno't be undone.</p>
            <span className="text-center text-lg font-medium">Are you sure you want to delete <b>{"John Doe"}</b> in the staff list?</span>
